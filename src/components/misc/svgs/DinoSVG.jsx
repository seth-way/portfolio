...
const head = {
	...
	variants: {
		...
		chase: {
			rotate: [0, 10, 0],
			times: [0, 0.5, 1],
			transition: { duration: 1, repeat: Infinity, transition: 'easeInOut' }
		}
	}
};
...
const arms = [
	{
		...
		variants: {
			...
			chase: {
				rotate: [0, 15, 0],
				times: [0, 0.5, 1],
				transition: { duration: 1.5, repeat: Infinity, transition: 'easeInOut' }
			}
		}
	},
	{
...
const [dinoX, dinoY] = [0, 0];
const [headX, headY] = [0, 0];
const [arm1X, arm1Y] = [0, 0];
const [arm2X, arm2Y] = [0, 0];

const animate1 = { rotate: [0, 0, 0] };
const animate2 = { rotate: [0, 30, 0] };
const animate3 = { rotate: [0, -30, 0] };

const transition1 = { duration: 2, repeat: Infinity, ease: 'easeInOut' };
// const [dinoX, dinoY] = [0, 0];
...
const DinoSVG = () => {
	...
	const chase = () => {
		setDinoAnimate('chase');
		setHeadAnimate('chase');
		setJawsAnimate('chase');
		setArmsAnimate('chase');
	};
