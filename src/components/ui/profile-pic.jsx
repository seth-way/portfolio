...
export default function ProfilePic() {
  ...
  const rotation2R = useTransform(rotation2, value => -0.9 * value);
      ...
      >
        <defs>
          ...
          <linearGradient id='semiCircle1' x1='0' y1='0' x2='0' y2='1'>
            ...
            <stop
              offset='45%'
              style={{ stopColor: 'var(--alt_C)', stopOpacity: 0.1 }}
            />
            <stop
              offset='100%'
          ...
          <linearGradient id='semiCircle2' x1='0' y1='0' x2='0' y2='1'>
            ...
            <stop
              offset='20%'
              style={{ stopColor: 'var(--accent_C)', stopOpacity: 0.35 }}
            />
            <stop
              offset='100%'
          ...
          <linearGradient id='semiCircle3' x1='0' y1='0' x2='0' y2='1'>
            ...
            <stop
              offset='20%'
              style={{ stopColor: 'var(--primary_C)', stopOpacity: 0.1 }}
            />
            <stop
              offset='100%'
          ...
          <radialGradient id='semiCircle4' cx='0.9' cy='0.9' r='0.75'>
            <stop
              offset='0%'
        ...
        ></image>
        <motion.g
          style={{ rotate: rotation1, originX: 'center', originY: 'center' }}
        >
          <motion.path
        ...
        <motion.g
          style={{ rotate: rotation2R, originX: 'center', originY: 'center' }}
        >
          <path
        ...
        <motion.g
          style={{ rotate: rotation3, originX: 'center', originY: 'center' }}
        >
          <path
        ...
        <motion.g
          style={{ rotate: rotation4R, originX: 'center', originY: 'center' }}
        >
          <path
